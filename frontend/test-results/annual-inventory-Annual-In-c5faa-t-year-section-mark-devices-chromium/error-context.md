...
- Name: annual-inventory.spec.js >> Annual Inventory Workflow >> Annual inventory workflow: select year, section, mark devices
- Location: e2e\annual-inventory.spec.js:13:3
