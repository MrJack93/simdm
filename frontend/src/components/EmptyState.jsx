...
export default function EmptyState({
  ...
  return (
    <div
      ...
      role="status"
    >
      <div className="w-16 h-16 rounded-full flex items-center justify-center mb-6 bg-[var(--color-bg-tertiary)]">
        <Icon size={32} className="text-[var(--color-text-tertiary)]" />
      </div>

      <h3
        className="text-lg font-medium mb-2 text-[var(--color-text-primary)]"
